 ...
 */
package com.metagamedsl.individual.generator

import com.metagamedsl.individual.metaGameLanguage.Action
import com.metagamedsl.individual.metaGameLanguage.Add
import com.metagamedsl.individual.metaGameLanguage.And
import com.metagamedsl.individual.metaGameLanguage.Argument
import com.metagamedsl.individual.metaGameLanguage.Assignment
import com.metagamedsl.individual.metaGameLanguage.BoolExp
import com.metagamedsl.individual.metaGameLanguage.BooleanValue
import com.metagamedsl.individual.metaGameLanguage.Comparison
import com.metagamedsl.individual.metaGameLanguage.Coordinates
import com.metagamedsl.individual.metaGameLanguage.Dec
import com.metagamedsl.individual.metaGameLanguage.Declaration
import com.metagamedsl.individual.metaGameLanguage.Div
import com.metagamedsl.individual.metaGameLanguage.DivEq
import com.metagamedsl.individual.metaGameLanguage.Eq
import com.metagamedsl.individual.metaGameLanguage.Expression
import com.metagamedsl.individual.metaGameLanguage.Game
import com.metagamedsl.individual.metaGameLanguage.Inc
import com.metagamedsl.individual.metaGameLanguage.InternalFunction
...
import com.metagamedsl.individual.metaGameLanguage.MinusEq
import com.metagamedsl.individual.metaGameLanguage.Mult
import com.metagamedsl.individual.metaGameLanguage.MultEq
import com.metagamedsl.individual.metaGameLanguage.Number
...
import com.metagamedsl.individual.metaGameLanguage.PlusEq
...
import com.metagamedsl.individual.metaGameLanguage.VarActionCondition
import com.metagamedsl.individual.metaGameLanguage.VarWinCondition
...
import com.metagamedsl.individual.metaGameLanguage.CustomFunction
import com.metagamedsl.individual.metaGameLanguage.Arguments
...
import com.metagamedsl.individual.metaGameLanguage.Arg
import com.metagamedsl.individual.metaGameLanguage.Objdec
import com.metagamedsl.individual.metaGameLanguage.Locdec
...
public class «game.name» extends FluentMachine {
	...
	def dispatch CharSequence generateCondition(InternalFunction f) {
		...
		for (arg:f.arguments?.arguments) {
			switch arg {
				Arg: names.add(arg.arg.name)
	...
	def dispatch CharSequence generateEffect(CustomFunction cf) '''
		
	    // delete in object
        List<Object>objectsToRemove = new ArrayList<>();
        for(int i=0; i<model.getAllObjects().size(); i++){
            if(model.getAllObjects().get(i).getPosition().X == «cf.arguments?.arguments.get(1).name».getPositions().get(0).X &&
                    model.getAllObjects().get(i).getPosition().Y == «cf.arguments?.arguments.get(1).name».getPositions().get(0).Y &&
                    model.getAllObjects().get(i).getName() != «cf.arguments?.arguments.get(0).name».getName()){
        ...
        for(int i=0; i<model.getAllLocations().size(); i++){
            for(int y=0; y<model.getAllLocations().get(i).getPositions().size(); y++){
                if(model.getAllLocations().get(i).getPositions().get(y).X == «cf.arguments?.arguments.get(1).name».getPositions().get(0).X &&
                        model.getAllLocations().get(i).getPositions().get(y).Y == «cf.arguments?.arguments.get(1).name».getPositions().get(0).Y ){
	...
	def dispatch generateArgName(Argument arg) {
		arg.name
	}	
	
	def dispatch generateArgName(ObjectDeclaration od) {
		"map.get(\"" + od.name + "\")"
	}
	def dispatch generateArgName(LocationDeclaration ld) {
		"map.get(\"" + ld.name + "\")"
	}
	...
	def String generateMathExp(Expression exp, boolean isArg) {
	    switch exp {
	        ...
	        LocalVariable: {
	        	var local = ""
	        	if (isArg) {
	        		local = exp.var_local+".getName()+\"" //  (boolean)map.get(player.getName()+".isAgent"))
	        	} else {
	        		local = "\""+exp.var_local // (int)map.get("Agent1.path"))
	        	}
	        	//System.out.println("LocalVariable: " + exp.var_local);
	        	exp.var_prop.getPropertyType + "map.get("+ local +"."+ exp.var_prop.name+"\")" 
	        }
	        Variable: {
	        	//System.out.println("Variable: " + exp.var_prop.name);
	        	exp.var_prop.getPropertyType + "map.get(\""+exp.var_prop.name+"\")" 
	        	
	        }// Ex taken from callback method: (((int)map.get("Agent1.path")) <= ((int)map.get("maxPathLength")));
